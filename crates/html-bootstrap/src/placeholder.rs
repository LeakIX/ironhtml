...
use html_elements::{Div, Span, A, P};
...
///
/// ```rust
/// use html_bootstrap::placeholder::{placeholder, PlaceholderWidth};
///
...
pub fn placeholder_sized(width: PlaceholderWidth, size: PlaceholderSize) -> Element<Span> {
    ...
    let class = if size_class.is_empty() {
        ...
        format!("placeholder {} {}", width.class(), size_class)
    };
    Element::<Span>::new().class(&class)
}
...
///
/// ```rust
/// use html_bootstrap::placeholder::placeholder_paragraph;
///
