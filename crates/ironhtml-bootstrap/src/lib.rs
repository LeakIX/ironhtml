...
//! that integrates seamlessly with the `ironhtml` ecosystem. Build
...
//!
//! - **[Landing Page](https://github.com/LeakIX/ironhtml/blob/main/crates/ironhtml-bootstrap/examples/landing_page.rs)** -
//!   A complete `SaaS` landing page with navbar, hero section, features, testimonials, and footer.
//!
//! - **[Wallet Dashboard](https://github.com/LeakIX/ironhtml/blob/main/crates/ironhtml-bootstrap/examples/wallet_dashboard.rs)** -
//!   Dynamic page generation based on Rust parameters, showing conditional rendering.
//!
//! - **[Bootstrap Docs](https://github.com/LeakIX/ironhtml/blob/main/crates/ironhtml-bootstrap/examples/bootstrap_docs.rs)** -
...
// Re-export ironhtml and ironhtml_elements for convenience
pub use ironhtml;
...
#[cfg(test)]
mod tests {
    use super::{Breakpoint, Color, NavbarExpand, Size};
