...
use ironhtml_elements::{Button, Div, A, H5};
...
impl OffcanvasPlacement {
    const fn class(self) -> &'static str {
        match self {
            Self::Start => "offcanvas-start",
            Self::End => "offcanvas-end",
            Self::Top => "offcanvas-top",
            Self::Bottom => "offcanvas-bottom",
        }
    }
}
...
///
/// ```rust
/// use ironhtml_bootstrap::offcanvas::offcanvas_button;
...
///
/// ```rust
/// use ironhtml_bootstrap::offcanvas::{offcanvas, OffcanvasPlacement};
///
