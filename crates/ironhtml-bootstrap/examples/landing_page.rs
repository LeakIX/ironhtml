...
use ironhtml_bootstrap::{cards, grid, navbar, NavbarExpand};
use ironhtml_elements::{
    Blockquote, Body, Br, Div, Footer, Head, Hr, Html, Li, Link, Meta, Nav, Script, Section, Small,
    Span, Strong, Title, Ul, A, H1, H2, H4, H5, H6, I, P,
};
    ...
    Element::<Footer>::new()
        ...
        .child::<Div, _>(|_| {
            grid::container(|c| {
                ...
                .child::<P, _>(|p| {
                    let copyright = alloc::format!("© {year} {company}. All rights reserved.");
...
fn sample_menu_items() -> alloc::vec::Vec<MenuItem> {
    alloc::vec![
        MenuItem {
            href: "#features",
            label: "Features",
...
fn sample_features() -> alloc::vec::Vec<Feature> {
    alloc::vec![
        Feature {
...
fn sample_pricing_tiers() -> alloc::vec::Vec<PricingTier> {
    alloc::vec![
        PricingTier {
            name: "Starter",
            price: "$9",
...
fn sample_testimonials() -> alloc::vec::Vec<Testimonial> {
    alloc::vec![
        Testimonial {
            quote: "ironhtml-bootstrap has revolutionized how we build web applications. The type safety is incredible!",
            author: "Sarah Chen",
...
fn main() {
    ...
    let pricing_tiers = sample_pricing_tiers();
            ...
            html.attr("lang", "en")
                .child::<Head, _>(|head| {
                    head.child::<Meta, _>(|m| m.attr("charset", "UTF-8"))
                        ...
                        .child::<Title, _>(|t| t.text("ironhtml-bootstrap - Type-Safe Bootstrap for Rust"))
                        .child::<Link, _>(|l| {
                ...
                .child::<Body, _>(|body| {
                    body
                        // Navigation
                        .child::<Nav, _>(|_| main_navbar("ironhtml-bootstrap", &menu_items))
                        // Hero
                        ...
                        // Footer
                        .child::<Footer, _>(|_| footer("ironhtml-bootstrap", "2024"))
                        // Bootstrap JS
                        .child::<Script, _>(|s| {
